                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 0.0),
                                    child: Text(
                                      'ขั้นตอนที่ 2 : กรอกรายละเอียดหลักทรัพย์',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Noto San Thai',
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (_model.isSearchByChanod) {
                                      ...
                                      if (_model.tarangWaTextFieldTextController
                                              .text ==
                                          '') {
                                        await showDialog(
                                          context: context,
                                    ...
                                    FFAppState().AppStateAREARAI =
                                        functions.removeCommaFromNumText(_model
                                            .raiTextFieldTextController.text)!;
                                    FFAppState().AppStateAREANGAN =
                                        functions.removeCommaFromNumText(_model
                                            .nganTextFieldTextController.text)!;
                                    ...
                                    _model.aPIcheckRateOutputMobile =
                                      ...
                                      utmmap:
                                          FFAppState().chanodOutput.utmmap != ''
                                              ...
                                              : '',
                                      landNo:
                                          FFAppState().chanodOutput.hasLandNo()
                                    ...
                                    _model.saveAPIOutputMobile =
                                      ...
                                      landAreaWa: FFAppState()
                                          ...
                                          : '',
                                      utmmap:
                                          FFAppState().chanodOutput.hasUtmmap()
                                              ? FFAppState().chanodOutput.utmmap
                                              : '',
                                      landNo:
                                          FFAppState().chanodOutput.hasLandNo()
                                      ...
                                      consentDate: '',
                                      leadSource: 'WEB',
                                      consentFlg: FFAppState().consentFlg,
                                      step: '2',
                                      utmSource: FFAppState().utmSourceAppState,
                                      utmMedium: FFAppState().utmMediumAppState,
                                      utmCampaign:
                                    ...
                                    FFAppState().ltv1AmountWeb = FFAppState()
                                        .chanodOutput
                                        .ltv1Amount
                                        .toString();
                                    FFAppState().ltv2AmountWeb = FFAppState()
                                        .chanodOutput
                                        .ltv2Amount
                                        .toString();
                                    safeSetState(() {});
                                    ...
                                    FFAppState().AppStateAREANGAN = '';
                                    FFAppState().AppStateAREAWA = '';
                                    FFAppState().customerDetailJson = null;
                                    FFAppState().leadsID = '';
                                    safeSetState(() {});
                                    Navigator.pop(context);

                                    context
                                        .goNamed(RateWebPageWidget.routeName);
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              TextFormField(
                                                                            controller:
                                                                                _model.chanodNumberTextFieldPCTextController,
                                                                            focusNode:
                                                                                _model.chanodNumberTextFieldPCFocusNode,
                                                                            autofocus:
                                                                                false,
                                                                            obscureText:
                                                                                false,
                                                                            ...
                                                                            cursorColor:
                                                                                FlutterFlowTheme.of(context).primaryText,
                                                                            validator:
                                                                                _model.chanodNumberTextFieldPCTextControllerValidator.asValidator(context),
                                                                          ),
                                                                        ),
                                                                      ),
                                                                    ),
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          ...
                                          if (_model.isSearchByChanod) {
                                            ...
                                            if (_model
                                                    .rawangTextFieldPCTextController
                                                    .text !=
                                                '') {
                                              if (!functions.checkRawang(_model
                                                  .rawangTextFieldPCTextController
