...
import '/index.dart';
import 'ploan_request_amount_page02_widget.dart'
    show PloanRequestAmountPage02Widget;
import 'package:flutter/material.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class PloanRequestAmountPage02Model
    extends FlutterFlowModel<PloanRequestAmountPage02Widget> {
  ...
  // Stores action output result for [Backend Call - API (Get topup detail )] action in PloanRequestAmountPage02 widget.
  ApiCallResponse? getTopupDetailAPIOutput;
  // Stores action output result for [Backend Call - API (post to calculator to get new topup)] action in PloanRequestAmountPage02 widget.
