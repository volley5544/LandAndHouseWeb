...
import 'ploan_request_amount_page02_model.dart';
export 'ploan_request_amount_page02_model.dart';

class PloanRequestAmountPage02Widget extends StatefulWidget {
  const PloanRequestAmountPage02Widget({super.key});

  static String routeName = 'PloanRequestAmountPage02';
  static String routePath = '/PloanRequestAmountPage02';

  @override
  State<PloanRequestAmountPage02Widget> createState() =>
      _PloanRequestAmountPage02WidgetState();
}

class _PloanRequestAmountPage02WidgetState
    extends State<PloanRequestAmountPage02Widget> {
  late PloanRequestAmountPage02Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PloanRequestAmountPage02Model());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().getTopupDataAPIResultAppstate =
          GetTopupDataAPIDataTypeStruct.maybeFromMap(
              (_model.getTopupDetailAPIOutput?.jsonBody ?? ''))!;
      safeSetState(() {});
      if (FFAppState().getLoanListSelected.topupSpecialFlag) {
        FFAppState().updateGetTopupDataAPIResultAppstateStruct(
          (e) => e
            ..topupSpecials =
                FFAppState().getLoanListSelected.topupDetail.topupSpecials
            ..defaultTopupAmount =
                FFAppState().getTopupDataAPIResultAppstate.defaultTopupAmount +
                    FFAppState().getLoanListSelected.topupDetail.topupSpecials
            ..maxTopupAmount =
  ...
  Widget build(BuildContext context) {
    ...
    return Builder(
      builder: (context) => Title(
          title: 'PloanRequestAmountPage02',
                  ...
                  children: [
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                wrapWithModel(
                                  model:
                                      _model.loanDetailCardTopupComponentModel,
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (FFAppState().savePLoanData.isNewPLoan)
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  24.0, 0.0, 24.0, 0.0),
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child:
                                                                ...
                                                                readOnly: (FFAppState()
                                                                            ...
                                                                            .interestPaidFlag ==
                                                                        'Y') ||
                                                                    ((FFAppState().saveTopupData.products !=
                                                                            ProductsStruct()) &&
                                                                        (FFAppState().saveTopupData.products.productPrice !=
                                                                            null)),
                                                                obscureText:
                                                                    false,
                                                                decoration:
                                                                  ...
                                                                  Builder(
                                                                    builder:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        value: _model
                                                                            .sliderValue ??= ((FFAppState().saveTopupData.products != ProductsStruct()) && false
                                                                                ? FFAppState().getTopupCalculateAppState.amount
                                                                                : valueOrDefault<int>(
                                                                                    FFAppState().getTopupDataAPIResultAppstate.defaultTopupAmount,
                                                                                    0,
                                                                                  ))
                                                                        ...
                                                                        divisions:
                                                                            (int max,
                                                                                int min) {
                                                                          return ((double.parse('${max}') - double.parse('${min}')) / 100.0)
                                                                              .round();
                                                                        }(FFAppState().getTopupDataAPIResultAppstate.maxTopupAmount, FFAppState().getTopupDataAPIResultAppstate.minTopupAmount),
                                                                        onChanged: ((FFAppState().getTopupDataAPIResultAppstate.interestPaidFlag == 'Y') ||
                                                                                ((FFAppState().saveTopupData.products != ProductsStruct()) && false))
                                                                            ? null
                                                                            : (newValue) {
                                                                        ...
                                                                        onChangeEnd:
                                                                          ...
                                                                          safeSetState(
                                                                              () {
                                                                            _model.textController?.text =
                                                                                functions.returnNumberWithCommaFullNumber('${functions.roundDownInput(_model.sliderValue?.toString())?.toString()}', '${FFAppState().getTopupDataAPIResultAppstate.defaultTopupAmount.toString()}')!;
                                                                            _model.textFieldMask.updateMask(
                                                                              newValue: TextEditingValue(
                                                                                text: _model.textController!.text,
                                                                              ),
                                                                          ...
                                                                          safeSetState(
                                                                              () {
                                                                            _model.sliderValue =
                                                                                functions.roundDownInput(functions.removeCommaFromNumText(_model.sliderValue?.toString()))!.toDouble();
                                                                          });
                                                                          unawaited(
                                                                            () async {}(),
                                                                          );
                                                                          ...
                                                                          _model.topupCalculateAPIOutputSlider = await SrisawadApiGroup
                                                                            ...
                                                                            loanAmount:
                                                                                double.parse(functions.roundDownInput(functions.removeCommaFromNumText(_model.sliderValue?.toString()))!.toString()),
                                                                            interestRate:
                                                                          ...
                                                                          _shouldSetState =
                                                                              true;
                                                                          if ((_model.topupCalculateAPIOutputSlider?.statusCode ?? 200) ==
                                                                              200) {
                                                                          } else {
                                                                            await showDialog(
                                                                              barrierDismissible: false,
                                                                              ...
                                                                              builder: (dialogContext) {
                                                                                return Dialog(
                                                                                  ...
                                                                                  child: GestureDetector(
                                                                                    ...
                                                                                    child: ErrorMessageComponentWidget(
                                                                                      textMessage: 'พบข้อผิดพลาด status (${(_model.topupCalculateAPIOutputSlider?.statusCode ?? 200).toString()})',
                                                                                    ),
                                                                                  ),
                                                                                );
                                                                              },
                                                                          ...
                                                                          FFAppState().getTopupCalculateAppState =
                                                                              TopupCalculateDataTypeStruct.maybeFromMap((_model.topupCalculateAPIOutputSlider?.jsonBody ?? ''))!;
                                                                          safeSetState(
                                                                              () {});
                                                                          FFAppState()
                                                                              .updateGetTopupDataAPIResultAppstateStruct(
                                                                            (e) => e
                                                                              ..feeAmount = FFAppState().getTopupCalculateAppState.feeAmount,
                                                                          );
                                                                          safeSetState(
                                                                              () {});
                                                                          Navigator.pop(
                                                                  ...
                                                                  Align(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        decoration:
                                                                            BoxDecoration(
                                                                          color: FFAppState().getTopupDataAPIResultAppstate.interestPaidFlag == 'Y'
                                                                              ? FlutterFlowTheme.of(context).secondaryText
                                                                              : FlutterFlowTheme.of(context).primary,
                                                                          borderRadius:
                                                                              BorderRadius.circular(16.0),
                    ...
                    if (((String textField, String minTopup) {
                      ...
                      Container(
                        ...
                        child: FutureBuilder<ApplicationRecord>(
                          future: ApplicationRecord.getDocumentOnce(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final columnApplicationRecord = snapshot.data!;
                                            ...
                                            child: Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: Text(
                                                      ('${FFAppState().getLoanListSelected.topupDetail.canTopupMsg}' !=
                                                                  'null') &&
                                                              ('${FFAppState().getLoanListSelected.topupDetail.canTopupMsg}' !=
                                                                  '')
                                                          ? '${FFAppState().getLoanListSelected.topupDetail.canTopupMsg}'
                                                          : columnApplicationRecord
                                                              .canTopupDefaultMsg,
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                      ...
                                                      if (false &&
                                                          ((FFAppState()
                                                              ...
                                                              (FFAppState()
                                                                      ...
                                                                      .canTopup !=
                                                                  'Y') ||
                                                              ((double.parse((functions.removeCommaFromNumText(
                                                                          '${FFAppState().getTopupCalculateAppState.amount.toString()}')!)) -
