...
import '/index.dart';
import 'ploan_conclusion_page06_widget.dart' show PloanConclusionPage06Widget;
import 'package:flutter/material.dart';

class PloanConclusionPage06Model
    extends FlutterFlowModel<PloanConclusionPage06Widget> {
  ...
  // Stores action output result for [Custom Action - uploadFileFirebaseStorage] action in PloanConclusionPage06 widget.
  String? idCardImageUrlCallback;
  // Stores action output result for [Alert Dialog - Custom Dialog] action in PloanConclusionPage06 widget.
  bool? changeDateOutputNewCamera;
  // Stores action output result for [Backend Call - API (visionThaiId)] action in PloanConclusionPage06 widget.
  ApiCallResponse? visionOutputThaiIdNewCamera;
  // Stores action output result for [Custom Action - convertBase64ToFFFiles] action in PloanConclusionPage06 widget.
  FFUploadedFile? generateIdCardFile;
  // Stores action output result for [Custom Action - uploadFileFirebaseStorage] action in PloanConclusionPage06 widget.
  String? selfieImageUrlCallback;
  // Stores action output result for [Custom Action - convertBase64ToFFFiles] action in PloanConclusionPage06 widget.
  FFUploadedFile? generateSelfieFile;
  // Stores action output result for [Backend Call - API (Send an pdf to user)] action in PloanConclusionPage06 widget.
  ...
  bool isDataUploading_uploadIdCardActionPL = false;
  FFUploadedFile uploadedLocalFile_uploadIdCardActionPL =
  ...
  bool isDataUploading_uploadSelfieActionPL = false;
  FFUploadedFile uploadedLocalFile_uploadSelfieActionPL =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
