...
import 'ploan_conclusion_page06_model.dart';
export 'ploan_conclusion_page06_model.dart';

class PloanConclusionPage06Widget extends StatefulWidget {
  const PloanConclusionPage06Widget({
    super.key,
    this.bankIcon,
  });
  ...
  static String routeName = 'PloanConclusionPage06';
  static String routePath = '/ploanConclusionPage06';

  @override
  State<PloanConclusionPage06Widget> createState() =>
      _PloanConclusionPage06WidgetState();
}

class _PloanConclusionPage06WidgetState
    extends State<PloanConclusionPage06Widget> {
  late PloanConclusionPage06Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PloanConclusionPage06Model());
                                                      ...
                                                      return Builder(
                                                        builder: (context) =>
                                                          ...
                                                          onPressed: () async {
                                                            ...
                                                            if (selectedMedia !=
                                                                ...
                                                                selectedMedia.every((m) =>
                                                                    validateFileFormat(
                                                                        ...
                                                                        context))) {
                                                              safeSetState(() =>
                                                                  _model.isDataUploading_uploadIdCardActionPL =
                                                                      true);
                                                              ...
                                                              if (selectedUploadedFiles
                                                                ...
                                                                safeSetState(
                                                                    () {
                                                                  _model.uploadedLocalFile_uploadIdCardActionPL =
                                                                      selectedUploadedFiles
                                                                          .first;
                                                                });
                                                              } else {
                                                            ...
                                                            if (!((_model
                                                                        .uploadedLocalFile_uploadIdCardActionPL
                                                                        .bytes
                                                                        ?.isNotEmpty ??
                                                                    false))) {
                                                              if (_shouldSetState)
                                                        ...
                                                        onPressed: () async {
                                                          ...
                                                          if (selectedMedia !=
                                                              ...
                                                              selectedMedia.every((m) =>
                                                                  validateFileFormat(
                                                                      ...
                                                                      context))) {
                                                            safeSetState(() =>
                                                                _model.isDataUploading_uploadSelfieActionPL =
                                                                    true);
                                                            var selectedUploadedFiles =
                                                                <FFUploadedFile>[];
                                                            ...
                                                            if (selectedUploadedFiles
                                                                ...
                                                                selectedMedia
                                                                    .length) {
                                                              safeSetState(() {
                                                                _model.uploadedLocalFile_uploadSelfieActionPL =
                                                                    selectedUploadedFiles
                                                                        .first;
                                                              });
                                                            } else {
                                                          ...
                                                          _model.selfieImageUrlOutput =
                                                            ...
                                                            FFAppState()
                                                                ...
                                                                : 'TopupC',
                                                            _model
                                                                .uploadedLocalFile_uploadSelfieActionPL,
                                                            FFAppState()
                                                                .getLoanListSelected
                                                                .contractNo,
                                                            FFAppState()
