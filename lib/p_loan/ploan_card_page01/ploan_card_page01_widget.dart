...
import 'ploan_card_page01_model.dart';
export 'ploan_card_page01_model.dart';

class PloanCardPage01Widget extends StatefulWidget {
  const PloanCardPage01Widget({
    super.key,
    this.token,
    this.hashThaiId,
    this.source,
  ...
  static String routeName = 'PloanCardPage01';
  static String routePath = '/PloanCardPage01';

  @override
  State<PloanCardPage01Widget> createState() => _PloanCardPage01WidgetState();
}

class _PloanCardPage01WidgetState extends State<PloanCardPage01Widget> {
  late PloanCardPage01Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PloanCardPage01Model());
    ...
    return Builder(
      builder: (context) => FutureBuilder<ApplicationRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final ploanCardPage01ApplicationRecord = snapshot.data!;

          return Title(
              title: 'PloanCardPage01',
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            '${ploanCardPage01ApplicationRecord.topupTextTitle}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Noto San Thai',
                                          ...
                                          Padding(
                                            ...
                                            child: Builder(
                                              builder: (context) {
                                                final listText =
                                                    ploanCardPage01ApplicationRecord
                                                        .topupTextList
                                                        .toList();
                                                            ...
                                                            TextSpan(
                                                              text: functions
                                                                      .containString(
                                                                          '*',
                                                                          warnningTextListItem)!
                                                                  ? ' ${ploanCardPage01ApplicationRecord.topupTextTime}'
                                                                  : '',
                                                              style: TextStyle(
                                                                decoration:
                                                                    TextDecoration
                                                                                  ...
                                                                                  child: Column(
                                                                                    ...
                                                                                    children: [
                                                                                      Container(
                                                                                        ...
                                                                                        decoration: BoxDecoration(),
                                                                                        child: Text(
                                                                                          ploanCardPage01ApplicationRecord.topupNoDataText,
                                                                                          textAlign: TextAlign.center,
                                                                                          style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                fontFamily: 'Noto San Thai',
                                                                                                color: FlutterFlowTheme.of(context).error,
                                                                                      ...
                                                                                      Container(
                                                                                        ...
                                                                                        decoration: BoxDecoration(),
                                                                                        child: Text(
                                                                                          ploanCardPage01ApplicationRecord.topupNoData2Text,
                                                                                          textAlign: TextAlign.center,
                                                                                          style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                fontFamily: 'Noto San Thai',
                                                                                                color: FlutterFlowTheme.of(context).error,
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                if (false && (loanListCarouselItemItem.topupDetail.products.length > 0) && ('${loanListCarouselItemItem.topupDetail.canTopup}' != 'N') && ('${loanListCarouselItemItem.requestStatus}' == 'ยังไม่ได้ทำรายการเติมเงิน'))
                                                                                  Padding(
                                                                                    padding: EdgeInsetsDirectional.fromSTEB(12.0, 12.0, 8.0, 12.0),
                                                                                    child: Container(
                                                                                      width: double.infinity,
                                                                                ...
                                                                                if (true || (loanListCarouselItemItem.topupDetail.products.length == 0) || ('${loanListCarouselItemItem.topupDetail.canTopup}' == 'N'))
                                                                                  Expanded(
                                                                                    child: Padding(
                                                                                                ...
                                                                                                return InkWell(
                                                                                                  ...
                                                                                                  onTap: () async {
                                                                                                    ...
                                                                                                    if (FFAppState().getLoanListSelected.requestStatus == 'ยังไม่ได้ทำรายการเติมเงิน' ? true : false) {
                                                                                                      ...
                                                                                                      context.pushNamed(
                                                                                                        PloanRequestAmountPage02Widget.routeName,
                                                                                                        extra: <String, dynamic>{
                                                                                                          '__transition_info__': TransitionInfo(
                                                                                                            hasTransition: true,
                                                                                                            transitionType: PageTransitionType.rightToLeft,
                                                                                                      ...
                                                                                                      context.pushNamed(
                                                                                                        PloanStatusPageWidget.routeName,
                                                                                                        extra: <String, dynamic>{
                                                                                                          '__transition_info__': TransitionInfo(
                                                                                                            hasTransition: true,
                                                                                                            transitionType: PageTransitionType.rightToLeft,
