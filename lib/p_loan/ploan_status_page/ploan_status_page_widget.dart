...
import 'ploan_status_page_model.dart';
export 'ploan_status_page_model.dart';

class PloanStatusPageWidget extends StatefulWidget {
  const PloanStatusPageWidget({
    super.key,
    this.fromPage,
  });
  ...
  static String routeName = 'PloanStatusPage';
  static String routePath = '/PloanStatusPage';

  @override
  State<PloanStatusPageWidget> createState() => _PloanStatusPageWidgetState();
}

class _PloanStatusPageWidgetState extends State<PloanStatusPageWidget> {
  late PloanStatusPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PloanStatusPageModel());
                            ...
                            children: [
                              wrapWithModel(
                                ...
                                child: LoanDetailCardTopupComponentWidget(
                                  ...
                                  assetCode: _model
                                      .topupStatusData!.collateralInformation,
                                  productTypeCode:
                                      _model.topupStatusData!.loanTypeCode,
                                  assetName:
                                      _model.topupStatusData!.loanTypeName,
                                ),
                              ),
                              Padding(
