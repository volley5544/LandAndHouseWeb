...
import 'topup_card_page_old_copy1_model.dart';
export 'topup_card_page_old_copy1_model.dart';

class TopupCardPageOldCopy1Widget extends StatefulWidget {
  const TopupCardPageOldCopy1Widget({
    super.key,
    this.token,
    this.hashThaiId,
    this.source,
  ...
  static String routeName = 'topupCardPageOldCopy1';
  static String routePath = '/topupCardPageOld1';

  @override
  State<TopupCardPageOldCopy1Widget> createState() =>
      _TopupCardPageOldCopy1WidgetState();
}

class _TopupCardPageOldCopy1WidgetState
    extends State<TopupCardPageOldCopy1Widget> {
  late TopupCardPageOldCopy1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TopupCardPageOldCopy1Model());
    ...
    return Builder(
      builder: (context) => FutureBuilder<ApplicationRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final topupCardPageOldCopy1ApplicationRecord = snapshot.data!;

          return Title(
              title: 'topupCardPageOldCopy1',
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            '${topupCardPageOldCopy1ApplicationRecord.topupTextTitle}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Noto San Thai',
                                          ...
                                          Padding(
                                            ...
                                            child: Builder(
                                              builder: (context) {
                                                final listText =
                                                    topupCardPageOldCopy1ApplicationRecord
                                                        .topupTextList
                                                        .toList();
                                                                                ...
                                                                                child: Column(
                                                                                  ...
                                                                                  children: [
                                                                                    Container(
                                                                                      ...
                                                                                      decoration: BoxDecoration(),
                                                                                      child: Text(
                                                                                        topupCardPageOldCopy1ApplicationRecord.topupNoDataText,
                                                                                        textAlign: TextAlign.center,
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              fontFamily: 'Noto San Thai',
                                                                                              color: FlutterFlowTheme.of(context).error,
                                                                                    ...
                                                                                    Container(
                                                                                      ...
                                                                                      decoration: BoxDecoration(),
                                                                                      child: Text(
                                                                                        topupCardPageOldCopy1ApplicationRecord.topupNoData2Text,
                                                                                        textAlign: TextAlign.center,
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              fontFamily: 'Noto San Thai',
                                                                                              color: FlutterFlowTheme.of(context).error,
