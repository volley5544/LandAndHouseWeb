...
import 'customer_application_list_page_model.dart';
export 'customer_application_list_page_model.dart';

class CustomerApplicationListPageWidget extends StatefulWidget {
  const CustomerApplicationListPageWidget({super.key});

  static String routeName = 'CustomerApplicationListPage';
  static String routePath = '/customerApplicationListPage';

  @override
  State<CustomerApplicationListPageWidget> createState() =>
      _CustomerApplicationListPageWidgetState();
}

class _CustomerApplicationListPageWidgetState
    extends State<CustomerApplicationListPageWidget> {
  late CustomerApplicationListPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomerApplicationListPageModel());
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                ProgressLeadComponentNewWidget(
                                                                  key: Key(
                                                                      'Keyzv3_${leadListItemsIndex}_of_${leadListItems.length}'),
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      ProgressLeadComponentNewWidget(
                                                                        key: Key(
                                                                            'Keyz7i_${leadListItemsIndex}_of_${leadListItems.length}'),
