...
import '/index.dart';
import 'topup_card_page_copy_copy_copy_widget.dart'
    show TopupCardPageCopyCopyCopyWidget;
import 'package:flutter/material.dart';

class TopupCardPageCopyCopyCopyModel
    extends FlutterFlowModel<TopupCardPageCopyCopyCopyWidget> {
  ...
  // Stores action output result for [Custom Action - saveVideoFile] action in topupCardPageCopyCopyCopy widget.
  String? resultText;
  // Stores action output result for [Custom Action - getFFUploadFileFromFilePath] action in topupCardPageCopyCopyCopy widget.
  FFUploadedFile? fileVideoOutput;
  // Stores action output result for [Backend Call - Read Document] action in topupCardPageCopyCopyCopy widget.
  ApplicationRecord? configOutput;
  // Stores action output result for [Backend Call - API (userDetail)] action in topupCardPageCopyCopyCopy widget.
