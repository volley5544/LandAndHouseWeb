...
import 'topup_card_page_old_model.dart';
export 'topup_card_page_old_model.dart';

class TopupCardPageOldWidget extends StatefulWidget {
  const TopupCardPageOldWidget({
    super.key,
    this.token,
    this.hashThaiId,
    this.source,
  ...
  static String routeName = 'topupCardPageOld';
  static String routePath = '/topupCardPageOld';

  @override
  State<TopupCardPageOldWidget> createState() => _TopupCardPageOldWidgetState();
}

class _TopupCardPageOldWidgetState extends State<TopupCardPageOldWidget> {
  late TopupCardPageOldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TopupCardPageOldModel());
    ...
    return Builder(
      builder: (context) => FutureBuilder<ApplicationRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final topupCardPageOldApplicationRecord = snapshot.data!;

          return Title(
              title: 'topupCardPageOld',
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            '${topupCardPageOldApplicationRecord.topupTextTitle}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Noto San Thai',
                                          ...
                                          Padding(
                                            ...
                                            child: Builder(
                                              builder: (context) {
                                                final listText =
                                                    topupCardPageOldApplicationRecord
                                                        .topupTextList
                                                        .toList();
                                                                                ...
                                                                                child: Column(
                                                                                  ...
                                                                                  children: [
                                                                                    Container(
                                                                                      ...
                                                                                      decoration: BoxDecoration(),
                                                                                      child: Text(
                                                                                        topupCardPageOldApplicationRecord.topupNoDataText,
                                                                                        textAlign: TextAlign.center,
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              fontFamily: 'Noto San Thai',
                                                                                              color: FlutterFlowTheme.of(context).error,
                                                                                    ...
                                                                                    Container(
                                                                                      ...
                                                                                      decoration: BoxDecoration(),
                                                                                      child: Text(
                                                                                        topupCardPageOldApplicationRecord.topupNoData2Text,
                                                                                        textAlign: TextAlign.center,
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              fontFamily: 'Noto San Thai',
                                                                                              color: FlutterFlowTheme.of(context).error,
