...
import '/index.dart';
import 'topup_card_page_old_widget.dart' show TopupCardPageOldWidget;
import 'package:flutter/material.dart';

class TopupCardPageOldModel extends FlutterFlowModel<TopupCardPageOldWidget> {
  ...
  // Stores action output result for [Custom Action - saveVideoFile] action in topupCardPageOld widget.
  String? resultText;
  // Stores action output result for [Custom Action - getFFUploadFileFromFilePath] action in topupCardPageOld widget.
  FFUploadedFile? fileVideoOutput;
  // Stores action output result for [Backend Call - Read Document] action in topupCardPageOld widget.
  ApplicationRecord? configOutput;
  // Stores action output result for [Backend Call - API (userDetail)] action in topupCardPageOld widget.
