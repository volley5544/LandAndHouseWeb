...
import '/index.dart';
import 'topup_card_page_copy_widget.dart' show TopupCardPageCopyWidget;
import 'package:flutter/material.dart';

class TopupCardPageCopyModel extends FlutterFlowModel<TopupCardPageCopyWidget> {
  ...
  // Stores action output result for [Custom Action - saveVideoFile] action in topupCardPageCopy widget.
  String? resultText;
  // Stores action output result for [Custom Action - getFFUploadFileFromFilePath] action in topupCardPageCopy widget.
  FFUploadedFile? fileVideoOutput;
  // Stores action output result for [Backend Call - Read Document] action in topupCardPageCopy widget.
  ApplicationRecord? configOutput;
  // Stores action output result for [Backend Call - API (userDetail)] action in topupCardPageCopy widget.
