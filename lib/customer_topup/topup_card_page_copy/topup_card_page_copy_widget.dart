...
import 'topup_card_page_copy_model.dart';
export 'topup_card_page_copy_model.dart';

class TopupCardPageCopyWidget extends StatefulWidget {
  const TopupCardPageCopyWidget({
    super.key,
    this.token,
    this.hashThaiId,
    this.source,
  ...
  static String routeName = 'topupCardPageCopy';
  static String routePath = '/topupCardPageCopy';

  @override
  State<TopupCardPageCopyWidget> createState() =>
      _TopupCardPageCopyWidgetState();
}

class _TopupCardPageCopyWidgetState extends State<TopupCardPageCopyWidget> {
  late TopupCardPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TopupCardPageCopyModel());
    ...
    return Builder(
      builder: (context) => FutureBuilder<ApplicationRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final topupCardPageCopyApplicationRecord = snapshot.data!;

          return Title(
              title: 'topupCardPageCopy',
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            '${topupCardPageCopyApplicationRecord.topupTextTitle}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Noto San Thai',
                                          ...
                                          Padding(
                                            ...
                                            child: Builder(
                                              builder: (context) {
                                                final listText =
                                                    topupCardPageCopyApplicationRecord
                                                        .topupTextList
                                                        .toList();
                                                                              ...
                                                                              children: [
                                                                                Container(
                                                                                  ...
                                                                                  child: Padding(
                                                                                    padding: EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 0.0, 0.0),
                                                                                    child: Text(
                                                                                      topupCardPageCopyApplicationRecord.topupNoDataText,
                                                                                      textAlign: TextAlign.center,
                                                                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                            fontFamily: 'Noto San Thai',
                                                                                            color: FlutterFlowTheme.of(context).secondaryText,
                                                                                ...
                                                                                Container(
                                                                                  ...
                                                                                  child: Padding(
                                                                                    padding: EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 0.0, 0.0),
                                                                                    child: Text(
                                                                                      topupCardPageCopyApplicationRecord.topupNoData2Text,
                                                                                      textAlign: TextAlign.center,
                                                                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                            fontFamily: 'Noto San Thai',
                                                                                            color: FlutterFlowTheme.of(context).secondaryText,
