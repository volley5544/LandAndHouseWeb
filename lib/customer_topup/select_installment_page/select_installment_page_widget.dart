...
import 'select_installment_page_model.dart';
export 'select_installment_page_model.dart';

class SelectInstallmentPageWidget extends StatefulWidget {
  const SelectInstallmentPageWidget({super.key});

  static String routeName = 'selectInstallmentPage';
  static String routePath = '/selectInstallmentPage';

  @override
  State<SelectInstallmentPageWidget> createState() =>
      _SelectInstallmentPageWidgetState();
}

class _SelectInstallmentPageWidgetState
    extends State<SelectInstallmentPageWidget> {
  late SelectInstallmentPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectInstallmentPageModel());
