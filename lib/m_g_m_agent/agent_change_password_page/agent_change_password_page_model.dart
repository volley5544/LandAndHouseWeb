...
class AgentChangePasswordPageModel
    extends FlutterFlowModel<AgentChangePasswordPageWidget> {
  ...
  late MaskTextInputFormatter phoneNumberTextFieldMask;
  String? Function(BuildContext, String?)?
      phoneNumberTextFieldTextControllerValidator;
  // Stores action output result for [Backend Call - API (check thai id phonenumber)] action in Container widget.
  ApiCallResponse? checkAPIOutput;
