...
import 'address_detail_page02_model.dart';
export 'address_detail_page02_model.dart';

class AddressDetailPage02Widget extends StatefulWidget {
  const AddressDetailPage02Widget({
    super.key,
    this.product,
  });
  ...
  static String routeName = 'AddressDetailPage02';
  static String routePath = '/AddressDetailPage';

  @override
  State<AddressDetailPage02Widget> createState() =>
      _AddressDetailPage02WidgetState();
}

class _AddressDetailPage02WidgetState extends State<AddressDetailPage02Widget>
    with TickerProviderStateMixin {
  late AddressDetailPage02Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddressDetailPage02Model());
              ...
              if (MediaQuery.sizeOf(context).width < kBreakpointSmall) {
                ...
                ? AppBar(
                    ...
                    flexibleSpace: FlexibleSpaceBar(
                      title: Text(
                        'จัดการที่อยู่${FFDevEnvironmentValues().isProduction ? '' : ' (UAT V.${FFAppState().webUatVersion.toString()})'}',
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Flexible(
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          if (!(_model.addressTextfieldTextController
                                                      .text !=
                                                  '')) {
                                            await showDialog(
                                              context: context,
                                          ...
                                          if (FFAppState().addressOutput ==
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  content: Text(
                                                      'กรุณาระบุจังหวัด เขต/อำเภอ แขวง/ตำบล รหัสไปรษณีย์'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
