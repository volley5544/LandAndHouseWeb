...
import 'side_nav_component_model.dart';
export 'side_nav_component_model.dart';

class SideNavComponentWidget extends StatefulWidget {
  const SideNavComponentWidget({super.key});

  @override
  State<SideNavComponentWidget> createState() => _SideNavComponentWidgetState();
}

class _SideNavComponentWidgetState extends State<SideNavComponentWidget> {
  late SideNavComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SideNavComponentModel());
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.asset(
                          'assets/images/display_image_(1).jpg',
                          width: 44.0,
                          height: 44.0,
                          fit: BoxFit.cover,
                        ),
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'คุณ${FFAppState().agentProfileDataType.agentNameTh}',
                            style:
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  if ('${FFAppState().agentProfileDataType.agentDocStatus}' !=
                      'COMPLETED')
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: badges.Badge(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              context
                                  .pushNamed(AgentDetailPage01Widget.routeName);
                            },
                            child: AnimatedContainer(
                              duration: Duration(milliseconds: 200),
                              curve: Curves.easeInOut,
