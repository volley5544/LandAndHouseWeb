                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'ข้อมูล ณ วันที่ ${_model.commissionData?.dataDate}',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Noto San Thai',
                                            ...
                                            children: [
                                              Expanded(
                                                child: FlutterFlowChoiceChips(
                                                  options: [
                                                    ChipData('รอจ่ายค่างวด'),
                                                    ChipData('จ่ายแล้ว'),
                                                    ChipData('รออนุมัติ'),
                                                    ChipData('ได้รับในรอบถัดไป')
                                                  ],
                                                  onChanged: (val) async {
                                                    safeSetState(() => _model
                                                            .choiceChipsValues =
                                                      ...
                                                      if ((_model.choiceChipsValues !=
                                                        ...
                                                        return _model
                                                            ...
                                                            .where((e) =>
                                                                ...
                                                                0)
                                                            .toList();
                                                      } else if ((_model.choiceChipsValues !=
                                                                  null &&
                                                              (_model.choiceChipsValues)!
                                                                  .isNotEmpty) &&
                                                          (_model.choiceChipsValues
                                                        ...
                                                        children: [
                                                          ...
                                                          Column(
                                                            ...
                                                            children: [
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                          '${leadListItemsItem.product}' == 'loan'
                                                                              ? '${functions.returnNumberWithComma2Decimal(leadListItemsItem.arnow)} บาท'
                                                              ...
                                                              if (double.parse((leadListItemsItem
                                                                              .expDay !=
                                                                          ''
                                                                      ? leadListItemsItem
                                                                          .expDay
                                                                ...
                                                                Expanded(
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      context
                                                                          .pushNamed(
                                                                        CommissionHistoryPageWidget
                                                                            .routeName,
                                                                        queryParameters:
                                                                            {
                                                                          'leadId':
                                                                              serializeParam(
                                                                            leadListItemsItem.id.toString(),
                                                                            ParamType.String,
                                                                          ),
                                                                        }.withoutNulls,
                                                                      );
