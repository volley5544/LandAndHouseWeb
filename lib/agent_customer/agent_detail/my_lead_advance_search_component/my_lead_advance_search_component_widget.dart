...
import 'my_lead_advance_search_component_model.dart';
export 'my_lead_advance_search_component_model.dart';

class MyLeadAdvanceSearchComponentWidget extends StatefulWidget {
  const MyLeadAdvanceSearchComponentWidget({
    super.key,
    required this.showingLeadData,
  });

  final List<LeadAgentDataModelStruct>? showingLeadData;

  @override
  State<MyLeadAdvanceSearchComponentWidget> createState() =>
      _MyLeadAdvanceSearchComponentWidgetState();
}

class _MyLeadAdvanceSearchComponentWidgetState
    extends State<MyLeadAdvanceSearchComponentWidget> {
  late MyLeadAdvanceSearchComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyLeadAdvanceSearchComponentModel());
                        ...
                        children: [
                          Expanded(
                            child: FlutterFlowDropDown<String>(
                              controller:
                                  _model.leadStatusDropDownValueController ??=
                              ...
                              onChanged: (val) => safeSetState(
                                  () => _model.leadStatusDropDownValue = val),
                              width: 200.0,
                              height: 40.0,
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  Navigator.pop(context, <String, dynamic>{
                    'leadStatus': _model.leadStatusDropDownValue != null &&
                            _model.leadStatusDropDownValue != ''
                        ? _model.leadStatusDropDownValue
                        : '${''}',
