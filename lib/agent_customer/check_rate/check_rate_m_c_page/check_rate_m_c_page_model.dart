...
import '/index.dart';
import 'check_rate_m_c_page_widget.dart' show CheckRateMCPageWidget;
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class CheckRateMCPageModel extends FlutterFlowModel<CheckRateMCPageWidget> {
  ...
  // Stores action output result for [Backend Call - Read Document] action in CheckRateMCPage widget.
  ApplicationRecord? queryUrl;
  // Stores action output result for [Custom Action - convertBase64ToFFFiles] action in CheckRateMCPage widget.
  FFUploadedFile? generateBluebookFile;
  // Stores action output result for [Backend Call - API (get Province)] action in CheckRateMCPage widget.
  ApiCallResponse? provinceApiOutput;
  // Stores action output result for [Backend Call - API (rateGetVehicle)] action in CheckRateMCPage widget.
