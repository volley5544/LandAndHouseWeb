...
import 'check_rate_m_c_page_model.dart';
export 'check_rate_m_c_page_model.dart';

class CheckRateMCPageWidget extends StatefulWidget {
  const CheckRateMCPageWidget({
    super.key,
    this.product,
    this.customerId,
    this.projectCode,
  ...
  static String routeName = 'CheckRateMCPage';
  static String routePath = '/checkRateMCPage';

  @override
  State<CheckRateMCPageWidget> createState() => _CheckRateMCPageWidgetState();
}

class _CheckRateMCPageWidgetState extends State<CheckRateMCPageWidget>
    with TickerProviderStateMixin {
  late CheckRateMCPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CheckRateMCPageModel());
        ...
        Future(() async {
          ...
          await actions.listenWebviewEventCamera(
            ...
            (cameraBase64, actionNameOutput) async {
              ...
              if (actionNameOutput != 'searchpagebluebook') {
                return;
              }
            ...
            child: Scaffold(
              ...
              appBar: AppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  title: Text(
                    'กรุณากรอกข้อมูลให้ถูกต้อง${FFDevEnvironmentValues().isProduction ? '' : ' (UAT V.${FFAppState().webUatVersion.toString()})'}',
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if ((_model.dropDownGearValue != null &&
                                          _model.dropDownGearValue != '') &&
                                      (_model
                                          .brandMasterPageState.isNotEmpty) &&
                                      (_model.stateNumber! >= 2))
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 16.0, 0.0, 0.0),
                                  ...
                                  if ((_model.dropDownBrand11Value != null &&
                                      ...
                                      (_model.dropDownYearValue != null &&
                                          _model.dropDownYearValue != '') &&
                                      (_model
                                          .modelMasterPageState.isNotEmpty) &&
                                      (_model.stateNumber! >= 4))
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 16.0, 0.0, 0.0),
                                                ...
                                                builder: (context) =>
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    if (_model.carRateData !=
                                                      ...
                                                      if (_model.rateFromApiTextController
                                                                  .text ==
                                                              '0.00'
                                                          ? true
                                                          : false) {
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: FlutterFlowDropDown<
                                                        String>(
                                                      controller: _model
                                                              .dropDownProvinceValueController ??=
                                                          FormFieldController<
                                                              String>(null),
                                                        ...
                                                        '${valueOrDefault<String>(
                                                          functions.returnNumberWithComma2Decimal(FFAppState()
                                                              ...
                                                              ? (FFAppState().maxCommissionAmountInstallment < 0.0
                                                                  ? (((double.parse((functions.removeCommaFromNumText(_model.loanAmountTextController.text)!))) * (double.parse((FFAppState().agentProfileDataType.paymentMethod == 'installment' ? (FFAppState().agentProfileDataType.actualPercent != '' ? FFAppState().agentProfileDataType.actualPercent : '0') : (FFAppState().agentProfileDataType.actualPercent != '' ? FFAppState().agentProfileDataType.actualPercent : '0')))) / 100)
                                                                      .toString())
                                                                  : (double.parse((((double.parse((functions.removeCommaFromNumText(_model.loanAmountTextController.text)!))) * (double.parse((FFAppState().agentProfileDataType.paymentMethod == 'installment' ? (FFAppState().agentProfileDataType.actualPercent != '' ? FFAppState().agentProfileDataType.actualPercent : '0') : (FFAppState().agentProfileDataType.actualPercent != '' ? FFAppState().agentProfileDataType.actualPercent : '0')))) / 100).toString())) < FFAppState().maxCommissionAmountInstallment
                                                                      ? (((double.parse((functions.removeCommaFromNumText(_model.loanAmountTextController.text)!))) * (double.parse((FFAppState().agentProfileDataType.paymentMethod == 'installment' ? (FFAppState().agentProfileDataType.actualPercent != '' ? FFAppState().agentProfileDataType.actualPercent : '0') : (FFAppState().agentProfileDataType.actualPercent != '' ? FFAppState().agentProfileDataType.actualPercent : '0')))) / 100)
                                                                          .toString())
                                                              ...
                                                              : (FFAppState().maxCommissionAmountOnetime < 0.0
                                                                  ...
                                                                  : (double.parse((((double.parse((functions.removeCommaFromNumText(_model.loanAmountTextController.text)!))) * (double.parse((FFAppState().agentProfileDataType.paymentMethod == 'installment' ? (FFAppState().agentProfileDataType.actualPercent != '' ? FFAppState().agentProfileDataType.actualPercent : '0') : (FFAppState().agentProfileDataType.actualPercent != '' ? FFAppState().agentProfileDataType.actualPercent : '0')))) / 100).toString())) <
                                                                      ...
                                                                      ? (((double.parse((functions.removeCommaFromNumText(_model.loanAmountTextController.text)!))) *
                                                                              (double.parse((FFAppState().agentProfileDataType.paymentMethod == 'installment' ? (FFAppState().agentProfileDataType.actualPercent != '' ? FFAppState().agentProfileDataType.actualPercent : '0') : (FFAppState().agentProfileDataType.actualPercent != '' ? FFAppState().agentProfileDataType.actualPercent : '0')))) /
                                                                              100)
                                                                          .toString())
                                    ...
                                    builder: (context) => FFButtonWidget(
                                      onPressed: (!_model.canNextButton ||
                                          ...
                                          : () async {
                                              ...
                                              safeSetState(() {});
                                              _model.uploadedBluebookUrl =
                                                  await actions
                                                      .uploadFileFirebaseStorageCheckRate(
                                                'CheckRate${widget.product}',
                                                _model.bluebookFile,
                                                widget.projectCode,
                                                widget.customerId,
                                              );
                                              ...
                                              safeSetState(() {});
                                              _model.createCustomerApiOutput =
                                                  await OcrDataCenterGroup
                                                      .customerCreateApiCall
                                                      .call(
                                                checkRateDataJson: _model
                                                    .checkRateData
                                                    ?.toMap(),
                                                projectCode:
                                                    widget.projectCode,
