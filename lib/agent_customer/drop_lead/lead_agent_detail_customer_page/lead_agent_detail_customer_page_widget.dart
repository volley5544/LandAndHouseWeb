                                                                ...
                                                                : () async {
                                                                    ...
                                                                    if (_model
                                                                      ...
                                                                      if (FFAppState()
                                                                        ...
                                                                        _model.sendConsentSmsApiOutput = await AgentAPIGroup
                                                                            .sendConsentSmsApiCall
                                                                            .call(
                                                                          agentCode: FFAppState()
                                                                              .agentProfileDataType
                                                                              .agentCode,
                                                                          ...
                                                                          registerId: functions.removeDash(_model
                                                                              .idcardTextController
                                                                              .text),
                                                                          pathConsent: FFDevEnvironmentValues().isProduction
                                                                              ? FFAppState().apiUrlDocData.agentWebCustomerConsent
                                                                              : FFAppState().apiUrlDocData.agentWebCustomerConsentUat,
                                                                        ...
                                                                        _shouldSetState =
                                                                            true;
                                                                        if ((_model.sendConsentSmsApiOutput?.statusCode ??
                                                                                200) !=
                                                                            200) {
                                                                          await showDialog(
                                                                            context:
                                                                        ...
                                                                        _model.checkConsentStatusTimer =
                                                                          ...
                                                                          callback:
                                                                            ...
                                                                            _shouldSetState =
                                                                                true;
                                                                            if ((_model.checkConsentStatusApiOutput?.statusCode ?? 200) !=
                                                                                200) {
                                                                              await showDialog(
                                                                                context: context,
                                                                                builder: (dialogContext) {
                                                                      ...
                                                                      if ((FFAppState().platform ==
                                                                        ...
                                                                        if (widget.product ==
                                                                            'L') {
                                                                          context
                                                                              .pushNamed(LeadAgentDetailLHPageWidget.routeName);
                                                                        } else {
                                                                          context
                                                                              .pushNamed(
                                                                            LeadAgentDetailCarPageWidget.routeName,
                                                          ...
                                                          textStyle:
                                                              FlutterFlowTheme.of(
                                                                  ...
                                                                  .override(
                                                                    fontFamily:
                                                                        'Noto San Thai',
                                                                    color: (_model.customerConsentFlag != 'N') &&
                                                                            (_model.customerConsentFlag !=
                                                                                'Y') &&
                                                                            _model
                                                                                .appConfig!.isUseOtp
