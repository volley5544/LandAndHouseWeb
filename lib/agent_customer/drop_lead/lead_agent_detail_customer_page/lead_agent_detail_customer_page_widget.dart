                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (((_model.customerConsentFlag == 'P') ||
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        if (_model.customerConsentFlag == 'N')
                                          Container(
                                            width: double.infinity,
                                            decoration: BoxDecoration(),
                                            child: Padding(
                                                ...
                                                : () async {
                                                    ...
                                                    if (_model
                                                      ...
                                                      if (FFAppState()
                                                        ...
                                                        _model.sendConsentSmsApiOutput =
                                                          ...
                                                          registerId: functions
                                                              .removeDash(_model
                                                                  .idcardTextController
                                                                  .text),
                                                          pathConsent: FFDevEnvironmentValues()
                                                                  .isProduction
                                                              ? FFAppState()
                                                                  .apiUrlDocData
                                                        ...
                                                        _shouldSetState = true;
                                                        if ((_model.sendConsentSmsApiOutput
                                                                    ?.statusCode ??
                                                                200) !=
                                                            200) {
                                                          await showDialog(
                                                              ...
                                                              return Dialog(
                                                                ...
                                                                child:
                                                                  ...
                                                                  child:
                                                                      ErrorMessageComponentWidget(
                                                                    textMessage:
                                                                        'พบข้อผิดพลาด Connection(${(_model.sendConsentSmsApiOutput?.statusCode ?? 200).toString()})',
                                                                  ),
                                                                ),
                                                              );
                                                            },
                                                        ...
                                                        _model.checkConsentStatusTimer =
                                                          ...
                                                          callback:
                                                            ...
                                                            if ('${getJsonField(
                                                              ...
                                                              _model.smsCode =
                                                                  '${AgentAPIGroup.checkConsentStatusApiCall.token(
                                                                (_model.checkConsentStatusApiOutput
                                                                        ?.jsonBody ??
                                                                    ''),
                                                              )}';
                                  ...
                                  if ((_model.productSelected?.vehicleCode !=
                                          'LH') &&
                                      (_model.productSelected?.vehicleCode !=
                                          'LA') &&
                                      false)
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
