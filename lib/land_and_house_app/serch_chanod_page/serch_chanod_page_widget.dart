                      ...
                      Expanded(
                        child: wrapWithModel(
                          ...
                          child: UserInfoWidget(
                            ...
                            phone: FFAppState().customerDetailData.phoneNumber,
                          ),
                        ),
                      ),
                    ],
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if ((FFAppState().chanodOutput.ltv1Amount !=
                                          0) ||
                                      (FFAppState().chanodOutput.ltv2Amount !=
                                          0))
                                    Align(
                                      alignment: AlignmentDirectional(0.0, 0.0),
                                      child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  _model.saveAPIOutput =
                                    ...
                                    chanodNo:
                                        FFAppState().chanodOutput.hasChanodNo()
                                            ? FFAppState().chanodOutput.chanodNo
                                            : '',
                                    changwatName:
