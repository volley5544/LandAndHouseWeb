...
class _ImageManageComponentWidgetState extends State<ImageManageComponentWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.chanodFrontFileParam != null &&
          (widget.chanodFrontFileParam?.bytes?.isNotEmpty ?? false)) {
        _model.chanodFrontFileTemp = widget.chanodFrontFileParam;
        safeSetState(() {});
      }
      if (widget.chanodBackFileParam != null &&
          (widget.chanodBackFileParam?.bytes?.isNotEmpty ?? false)) {
        _model.chanodBackFileTemp = widget.chanodBackFileParam;
        safeSetState(() {});
      }
    });
