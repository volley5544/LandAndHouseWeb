...
import 'add_customer_solar_lead_model.dart';
export 'add_customer_solar_lead_model.dart';

class AddCustomerSolarLeadWidget extends StatefulWidget {
  const AddCustomerSolarLeadWidget({
    super.key,
    this.hashThaiId,
    this.consentDate,
    String? projectName,
  ...
  static String routeName = 'AddCustomerSolarLead';
  static String routePath = '/AddCustomerSolarLead';

  @override
  State<AddCustomerSolarLeadWidget> createState() =>
      _AddCustomerSolarLeadWidgetState();
}

class _AddCustomerSolarLeadWidgetState
    extends State<AddCustomerSolarLeadWidget> {
  late AddCustomerSolarLeadModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddCustomerSolarLeadModel());
                                          ...
                                          onPressed: () async {
                                            ...
                                            FFAppState().utmCampaignAppState =
                                                functions.getUtmParamFromUrl(
                                                    'utm_campaign')!;
                                            safeSetState(() {});
                                            _model.getTokenAPIOutput =
                                                await SolarSystemGroup
                                                    .solarGetTokenCall
                                                    .call(
                                              nameTh: 'droplead_solar',
                                              password: 'a123456*',
                                              url: FFAppState()
                                                  .apiUrlDocData
                                                  .solarLeadApiUrl,
                                                  ...
                                                  return Dialog(
                                                    ...
                                                    child: GestureDetector(
                                                      ...
                                                      child:
                                                          ErrorMessageComponentWidget(
                                                        textMessage:
                                                            'พบข้อผิดพลาด connection (${(_model.getTokenAPIOutput?.statusCode ?? 200).toString()})',
                                                      ),
                                                    ),
                                                  );
                                                },
                                                  ...
                                                  return Dialog(
                                                    ...
                                                    child: GestureDetector(
                                                      ...
                                                      child:
                                                          ErrorMessageComponentWidget(
                                                        textMessage:
                                                            'พบข้อผิดพลาด connection (${(_model.solarSaveStep1?.statusCode ?? 200).toString()})',
                                                      ),
                                                    ),
                                                  );
                                                },
