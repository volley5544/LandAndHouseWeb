...
import 'solar_result_page_model.dart';
export 'solar_result_page_model.dart';

class SolarResultPageWidget extends StatefulWidget {
  const SolarResultPageWidget({
    super.key,
    this.ltv1Amount,
    this.ltv2Amount,
  });
  ...
  static String routeName = 'SolarResultPage';
  static String routePath = '/rateSolarPage';

  @override
  State<SolarResultPageWidget> createState() => _SolarResultPageWidgetState();
}

class _SolarResultPageWidgetState extends State<SolarResultPageWidget>
    with TickerProviderStateMixin {
  late SolarResultPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SolarResultPageModel());
