...
import '/components/search_location_component_widget.dart';
...
import 'solar_info_page_model.dart';
export 'solar_info_page_model.dart';

class SolarInfoPageWidget extends StatefulWidget {
  const SolarInfoPageWidget({super.key});

  static String routeName = 'SolarInfoPage';
  static String routePath = '/SolarInfoPage';

  @override
  State<SolarInfoPageWidget> createState() => _SolarInfoPageWidgetState();
}

class _SolarInfoPageWidgetState extends State<SolarInfoPageWidget>
    with TickerProviderStateMixin {
  late SolarInfoPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SolarInfoPageModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await _model.checkFromAddCustomerPage(context);
      safeSetState(() {});
      ...
      safeSetState(() {});
      _model.customerDataTemp = FFAppState().customerDetailJson;
      _model.leadIdTemp = FFAppState().leadsID;
      safeSetState(() {});
      await _model.checkTempParam(context);
      safeSetState(() {});
      _model.isSearchByChanod = true;
      _model.chanodTypeIsSelected = true;
      safeSetState(() {});
    ...
    _model.rawangTextFieldPCTextController ??= TextEditingController();
    _model.rawangTextFieldPCFocusNode ??= FocusNode();
    _model.rawangTextFieldPCFocusNode!.addListener(
      () async {
        if (_model.rawangTextFieldPCTextController.text != '') {
          if ((_model.rawangTextFieldPCFocusNode?.hasFocus ?? false)) {
            safeSetState(() {
              _model.rawangTextFieldPCTextController?.text =
                  functions.replaceSpaceInText(
                      _model.rawangTextFieldPCTextController.text)!;
            });
          } else {
    ...
    _model.raiTextFieldPCTextController ??= TextEditingController();
    _model.raiTextFieldPCFocusNode ??= FocusNode();
    _model.raiTextFieldPCFocusNode!.addListener(
      () async {
        if (_model.raiTextFieldPCTextController.text != '') {
          if ((_model.raiTextFieldPCFocusNode?.hasFocus ?? false)) {
            safeSetState(() {
    ...
    _model.nganTextFieldPCTextController ??= TextEditingController();
    _model.nganTextFieldPCFocusNode ??= FocusNode();
    _model.nganTextFieldPCFocusNode!.addListener(
      () async {
        if (_model.nganTextFieldPCTextController.text != '') {
          if ((_model.nganTextFieldPCFocusNode?.hasFocus ?? false)) {
            safeSetState(() {
    ...
    _model.tarangWaTextFieldPCTextController ??= TextEditingController();
    _model.tarangWaTextFieldPCFocusNode ??= FocusNode();
    _model.tarangWaTextFieldPCFocusNode!.addListener(
      () async {
        if (_model.tarangWaTextFieldPCTextController.text != '') {
          if ((_model.tarangWaTextFieldPCFocusNode?.hasFocus ?? false)) {
            safeSetState(() {
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    24.0, 8.0, 24.0, 0.0),
                                            child: Text(
                                              'วงเงินสูง ครอบคลุมค่าติดตั้ง  ผ่อนยาว\nช่วยลดค่าไฟระยะยาว สมัครง่าย รู้ผลไว',
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 12.0, 0.0, 0.0),
                                            child: Text(
                                              'ขั้นตอนที่ 2 : กรอกเอกสารเบื้องต้น',
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                                  .override(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                            ...
                                                            Expanded(
                                                              child: Container(
                                                                decoration:
                                                                    BoxDecoration(),
                                                                child: Text(
                                                                  'หมายเหตุ : ไม่รองรับการประเมินราคาห้องชุดและ นส.3 ก',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .bodyMedium
                                                                      .override(
                                                ...
                                                if (_model.chanodTypeIsSelected)
                                                  Column(
                                                    mainAxisSize:
                                                        MainAxisSize.max,
                                                    children: [
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            valueOrDefault<String>(
                                                                              _model.isSearchByChanod ? 'เลขโฉนด' : 'เลขที่ดิน',
                                                                              'เลขโฉนดที่ดิน',
                                                                            ),
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                TextFormField(
                                                                              controller: _model.chanodNumberTextFieldTextController,
                                                                              focusNode: _model.chanodNumberTextFieldFocusNode,
                                                                              autofocus: false,
                                                                              obscureText: false,
                                                                              ...
                                                                              validator: _model.chanodNumberTextFieldTextControllerValidator.asValidator(context),
                                                                            ),
                                                                          ),
                                                                        ),
                                                                      ),
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              width: double.infinity,
                                                                              child: TextFormField(
                                                                                controller: _model.rawangTextFieldTextController,
                                                                                focusNode: _model.rawangTextFieldFocusNode,
                                                                                autofocus: false,
                                                                                obscureText: false,
                                                                                decoration: InputDecoration(
                                                                                  isDense: false,
                                                                                ...
                                                                                cursorColor: FlutterFlowTheme.of(context).primaryText,
                                                                                validator: _model.rawangTextFieldTextControllerValidator.asValidator(context),
                                                                              ),
                                                                            ),
                                                                          ),
                                                                        ),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Text(
                                                                                FFAppState().addressOutput.subdistrictName,
                                                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                      fontFamily: 'Noto San Thai',
                                                                                      fontSize: () {
                                                                                        if (MediaQuery.sizeOf(context).width < kBreakpointSmall) {
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                TextFormField(
                                                                              controller: _model.raiTextFieldTextController,
                                                                              ...
                                                                              cursorColor: FlutterFlowTheme.of(context).primaryText,
                                                                              validator: _model.raiTextFieldTextControllerValidator.asValidator(context),
                                                                              inputFormatters: [
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                TextFormField(
                                                                              controller: _model.nganTextFieldTextController,
                                                                              ...
                                                                              keyboardType: TextInputType.phone,
                                                                              cursorColor: FlutterFlowTheme.of(context).primaryText,
                                                                              validator: _model.nganTextFieldTextControllerValidator.asValidator(context),
                                                                              inputFormatters: [
                                                                                FilteringTextInputFormatter.allow(RegExp('[0-9]'))
                                                                              ],
                                                                            ),
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                TextFormField(
                                                                              controller: _model.tarangWaTextFieldTextController,
                                                                              focusNode: _model.tarangWaTextFieldFocusNode,
                                                                              autofocus: false,
                                                                              obscureText: false,
                                                                              decoration: InputDecoration(
                                                                                isDense: false,
                                                                              ...
                                                                              cursorColor: FlutterFlowTheme.of(context).primaryText,
                                                                              validator: _model.tarangWaTextFieldTextControllerValidator.asValidator(context),
                                                                            ),
                                                                          ),
                                                                        ),
                                                                      ),
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: Container(
                                                                                  ...
                                                                                  child: ImageManageComponentWidget(
                                                                                    ...
                                                                                    resetImageValueChanodFront: () async {
                                                                                      _model.chanodFrontFile = null;
                                                                                      safeSetState(() {});
                                                                                    },
                                                                                    resetImageValueChanodBack: () async {
                                                                                      _model.chanodBackFile = null;
                                                                                      safeSetState(() {});
                                                                                    },
                                                                                  ),
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            await Navigator.push(
                                                                              ...
                                                                              PageTransition(
                                                                                ...
                                                                                child: FlutterFlowExpandedImageView(
                                                                                  image: Image.memory(
                                                                                    _model.landQuotationFile?.bytes ?? Uint8List.fromList([]),
                                                                                    fit: BoxFit.contain,
                                                                                  ),
                                                                                  allowRotation: false,
                                                                                  tag: 'imageTag4',
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        if (selectedMedia !=
                                                                            ...
                                                                            selectedMedia.every((m) =>
                                                                                validateFileFormat(m.storagePath, context))) {
                                                                          safeSetState(() =>
                                                                              _model.isDataUploading_uploadDataLandQuotationMobile = true);
                                                                          var selectedUploadedFiles =
                                                                              <FFUploadedFile>[];
                                                                          ...
                                                                          try {
                                                                            ...
                                                                            _model.isDataUploading_uploadDataLandQuotationMobile =
                                                                                false;
                                                                          }
                                                                          if (selectedUploadedFiles.length ==
                                                                              selectedMedia.length) {
                                                                            safeSetState(() {
                                                                              _model.uploadedLocalFile_uploadDataLandQuotationMobile = selectedUploadedFiles.first;
                                                                            });
                                                                          } else {
                                                                            safeSetState(() {});
                                                                            return;
                                                                        ...
                                                                        if ((_model.uploadedLocalFile_uploadDataLandQuotationMobile.bytes?.isNotEmpty ??
                                                                                false)) {
                                                                          ScaffoldMessenger.of(context)
                                                                              .clearSnackBars();
                                                                          ScaffoldMessenger.of(context)
                                                                        ...
                                                                        _model.landQuotationFile =
                                                                            _model.uploadedLocalFile_uploadDataLandQuotationMobile;
                                                                        safeSetState(
                                                                            () {});
                                                                      },
                                                                      text:
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SelectionArea(
                                              child: Text(
                                            'วงเงินสูง ครอบคลุมค่าติดตั้ง  ผ่อนยาว ช่วยลดค่าไฟระยะยาว สมัครง่าย รู้ผลไว',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Noto San Thai',
                                                                    ...
                                                                    Flexible(
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          await _model
                                                                              .checkFromAddCustomerPage(context);
                                                                          safeSetState(
                                                                              () {});
                                                                          await _model
                                                                              .checkTempParam(context);
                                                                          safeSetState(
                                                                              () {});
                                                                          _model.isSearchByChanod =
                                                                              true;
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          decoration:
                                                                            ...
                                                                            border:
                                                                                Border.all(
                                                                              color: _model.isSearchByChanod && _model.chanodTypeIsSelected ? FlutterFlowTheme.of(context).primary : FlutterFlowTheme.of(context).alternate,
                                                                              width: 2.0,
                                                                            ),
                                                                          ),
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Builder(
                                                                                  builder: (context) {
                                                                                    if (_model.isSearchByChanod && _model.chanodTypeIsSelected) {
                                                                                      return Icon(
                                                                                        Icons.check_circle,
                                                                                  ...
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: Container(
                                                                                      ...
                                                                                      child: Container(
                                                                                        width: double.infinity,
                                                                                        child: TextFormField(
                                                                                          controller: _model.thaiIdTextFieldPCTextController,
                                                                                          focusNode: _model.thaiIdTextFieldPCFocusNode,
                                                                                          autofocus: false,
                                                                                          obscureText: false,
                                                                                          decoration: InputDecoration(
                                                                                            isDense: false,
                                                                                          ...
                                                                                          keyboardType: TextInputType.number,
                                                                                          cursorColor: FlutterFlowTheme.of(context).primaryText,
                                                                                          validator: _model.thaiIdTextFieldPCTextControllerValidator.asValidator(context),
                                                                                          inputFormatters: [
                                                                                            _model.thaiIdTextFieldPCMask
                                                                                          ],
                                                                                        ),
                                                                                  ...
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: Container(
                                                                                      ...
                                                                                      child: Container(
                                                                                        width: double.infinity,
                                                                                        child: TextFormField(
                                                                                          controller: _model.chanodNumberTextFieldPCTextController,
                                                                                          focusNode: _model.chanodNumberTextFieldPCFocusNode,
                                                                                          autofocus: false,
                                                                                          obscureText: false,
                                                                                          decoration: InputDecoration(
                                                                                            isDense: false,
                                                                                          ...
                                                                                          keyboardType: TextInputType.number,
                                                                                          cursorColor: FlutterFlowTheme.of(context).primaryText,
                                                                                          validator: _model.chanodNumberTextFieldPCTextControllerValidator.asValidator(context),
                                                                                        ),
                                                                                      ),
                                                                                    ),
                                                                                  ),
                                                                                    ...
                                                                                    child: Padding(
                                                                                      ...
                                                                                      child: Container(
                                                                                        ...
                                                                                        child: Container(
                                                                                          width: double.infinity,
                                                                                          child: TextFormField(
                                                                                            controller: _model.rawangTextFieldPCTextController,
                                                                                            focusNode: _model.rawangTextFieldPCFocusNode,
                                                                                            autofocus: false,
                                                                                            obscureText: false,
                                                                                            decoration: InputDecoration(
                                                                                              isDense: false,
                                                                                            ...
                                                                                            buildCounter: (context, {required currentLength, required isFocused, maxLength}) => null,
                                                                                            cursorColor: FlutterFlowTheme.of(context).primaryText,
                                                                                            validator: _model.rawangTextFieldPCTextControllerValidator.asValidator(context),
                                                                                          ),
                                                                                        ),
                                                                                      ),
                                                                                    ),
                                                                                                    ...
                                                                                                    return Dialog(
                                                                                                      ...
                                                                                                      child: GestureDetector(
                                                                                                        ...
                                                                                                        child: Container(
                                                                                                          ...
                                                                                                          child: SearchLocationComponentWidget(),
                                                                                                        ),
                                                                                                      ),
                                                                                                    );
                                                                                                  },
                                                                                                ).then((value) => safeSetState(() => _model.addressOutput = value));

                                                                                                _model.temp = _model.addressOutput!;
                                                                                                safeSetState(() {});
                                                                                          ...
                                                                                          builder: (context) => Padding(
                                                                                            ...
                                                                                            child: InkWell(
                                                                                              ...
                                                                                              onTap: () async {
                                                                                                ...
                                                                                                ).then((value) => safeSetState(() => _model.addressOutput2 = value));
                                                                                          ...
                                                                                          builder: (context) => Padding(
                                                                                            ...
                                                                                            child: InkWell(
                                                                                              ...
                                                                                              onTap: () async {
                                                                                                ...
                                                                                                ).then((value) => safeSetState(() => _model.addressOutput3 = value));
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: Container(
                                                                                  width: double.infinity,
                                                                                  child: TextFormField(
                                                                                    controller: _model.raiTextFieldPCTextController,
                                                                                    focusNode: _model.raiTextFieldPCFocusNode,
                                                                                    autofocus: false,
                                                                                    obscureText: false,
                                                                                    decoration: InputDecoration(
                                                                                      isDense: false,
                                                                                    ...
                                                                                    keyboardType: TextInputType.phone,
                                                                                    cursorColor: FlutterFlowTheme.of(context).primaryText,
                                                                                    validator: _model.raiTextFieldPCTextControllerValidator.asValidator(context),
                                                                                    inputFormatters: [
                                                                                      FilteringTextInputFormatter.allow(RegExp('[0-9]'))
                                                                                    ],
                                                                                  ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: Container(
                                                                                  width: double.infinity,
                                                                                  child: TextFormField(
                                                                                    controller: _model.nganTextFieldPCTextController,
                                                                                    focusNode: _model.nganTextFieldPCFocusNode,
                                                                                    autofocus: false,
                                                                                    obscureText: false,
                                                                                    decoration: InputDecoration(
                                                                                      isDense: false,
                                                                                    ...
                                                                                    keyboardType: TextInputType.phone,
                                                                                    cursorColor: FlutterFlowTheme.of(context).primaryText,
                                                                                    validator: _model.nganTextFieldPCTextControllerValidator.asValidator(context),
                                                                                    inputFormatters: [
                                                                                      FilteringTextInputFormatter.allow(RegExp('[0-9]'))
                                                                                    ],
                                                                                  ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: Container(
                                                                                  width: double.infinity,
                                                                                  child: TextFormField(
                                                                                    controller: _model.tarangWaTextFieldPCTextController,
                                                                                    focusNode: _model.tarangWaTextFieldPCFocusNode,
                                                                                    autofocus: false,
                                                                                    obscureText: false,
                                                                                    decoration: InputDecoration(
                                                                                      isDense: false,
                                                                                    ...
                                                                                    keyboardType: TextInputType.number,
                                                                                    cursorColor: FlutterFlowTheme.of(context).primaryText,
                                                                                    validator: _model.tarangWaTextFieldPCTextControllerValidator.asValidator(context),
                                                                                    inputFormatters: [
                                                                                      FilteringTextInputFormatter.allow(RegExp('[0-9]'))
                                                                                    ],
                                                                                  ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              builder: (context) => FFButtonWidget(
                                                                                ...
                                                                                text: valueOrDefault<String>(
                                                                                  _model.houseRegFile.length > 0 ? 'จัดการรูปภาพ' : 'อัปโหลดรูปภาพ',
                                                                                  'อัปโหลดรูปภาพ',
                                                                                ),
                                                                                icon: Icon(
                                                                                  Icons.camera_alt_outlined,
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        if (_model.landQuotationFile !=
                                                                                null &&
                                                                            (_model.landQuotationFile?.bytes?.isNotEmpty ??
                                                                                false))
                                                                          Padding(
                                                                            padding: EdgeInsetsDirectional.fromSTEB(
                                                                                0.0,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              onPressed: () async {
                                                                                ...
                                                                                if (selectedMedia != null && selectedMedia.every((m) => validateFileFormat(m.storagePath, context))) {
                                                                                  safeSetState(() => _model.isDataUploading_uploadDataSqdLandQuotationWebPC = true);
                                                                                  var selectedUploadedFiles = <FFUploadedFile>[];
                                                                                  ...
                                                                                  try {
                                                                                    ...
                                                                                    _model.isDataUploading_uploadDataSqdLandQuotationWebPC = false;
                                                                                  }
                                                                                  if (selectedUploadedFiles.length == selectedMedia.length) {
                                                                                    safeSetState(() {
                                                                                      _model.uploadedLocalFile_uploadDataSqdLandQuotationWebPC = selectedUploadedFiles.first;
                                                                                    });
                                                                                  } else {
                                                                                    safeSetState(() {});
                                                                                    return;
                                                                                ...
                                                                                if ((_model.uploadedLocalFile_uploadDataSqdLandQuotationWebPC.bytes?.isNotEmpty ?? false)) {
                                                                                  ScaffoldMessenger.of(context).clearSnackBars();
                                                                                  ScaffoldMessenger.of(context).showSnackBar(
                                                                                    SnackBar(
                                                                                      content: Text(
                                                                                ...
                                                                                _model.landQuotationFile = _model.uploadedLocalFile_uploadDataSqdLandQuotationWebPC;
                                                                                safeSetState(() {});
                                                                              },
                                                                              text: 'อัปโหลดรูปภาพ',
                                                                              icon: Icon(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              builder: (context) => FFButtonWidget(
                                                                                ...
                                                                                text: valueOrDefault<String>(
                                                                                  _model.bookBankFile.length > 0 ? 'จัดการเอกสาร' : 'อัปโหลดเอกสาร',
                                                                                  'อัปโหลดเอกสาร',
                                                                                ),
                                                                                icon: Icon(
                                                                                  Icons.camera_alt_outlined,
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        if (_model.electricBill !=
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            ).animateOnPageLoad(animationsMap['imageOnPageLoadAnimation13']!),
                                                                          ),
                                                                        Padding(
                                                                          padding: EdgeInsetsDirectional.fromSTEB(
                                                                              0.0,
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            ...
                            if (selectedMedia != null &&
                              ...
                              safeSetState(() =>
                                  _model.isDataUploading_uploadNullValueAction =
                                      true);
                              var selectedUploadedFiles = <FFUploadedFile>[];
                              ...
                              if (selectedUploadedFiles.length ==
                                  selectedMedia.length) {
                                safeSetState(() {
                                  _model.uploadedLocalFile_uploadNullValueAction =
