...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    landAndHouseWebAuthUserSubject.add(
      LandAndHouseWebAuthUser(loggedIn: false),
    );
  ...
  Future<LandAndHouseWebAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Future<LandAndHouseWebAuthUser?> _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = LandAndHouseWebAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    landAndHouseWebAuthUserSubject.add(updatedUser);
...
LandAndHouseWebAuthUser? currentUser;
