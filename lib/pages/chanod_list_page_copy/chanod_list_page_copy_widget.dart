...
import 'chanod_list_page_copy_model.dart';
export 'chanod_list_page_copy_model.dart';

class ChanodListPageCopyWidget extends StatefulWidget {
  const ChanodListPageCopyWidget({super.key});

  static String routeName = 'ChanodListPageCopy';
  static String routePath = '/chanodListPageCopy';

  @override
  State<ChanodListPageCopyWidget> createState() =>
      _ChanodListPageCopyWidgetState();
}

class _ChanodListPageCopyWidgetState extends State<ChanodListPageCopyWidget> {
  late ChanodListPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChanodListPageCopyModel());
                            ...
                            if (_model.textController.text.length > 2) {
                              FFAppState().addressDataListOutput = FFAppState()
                                  ...
                                  .where((e) => functions.containString(
                                      _model.textController.text, e.keyword)!)
                                  .toList()
