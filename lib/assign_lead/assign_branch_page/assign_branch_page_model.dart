...
import '/index.dart';
import 'assign_branch_page_widget.dart' show AssignBranchPageWidget;
import 'package:flutter/material.dart';

class AssignBranchPageModel extends FlutterFlowModel<AssignBranchPageWidget> {
  ...
  // Stores action output result for [Backend Call - Read Document] action in AssignBranchPage widget.
  ApplicationRecord? queryAPIUrl;
  // Stores action output result for [Backend Call - API (GetListChanod)] action in AssignBranchPage widget.
